...
Modifierat av team: Sabina Bäck, Lucas Fransman, Alina Torbunova, 
Albert Valeev.
...
def main(): 
    ...
    # laddar ner data från olik kallor för vidare analys
    ...
    # anropar funktioner, som utför visualisering av data för uppgifter på nivå 3/5 och 5/5(3 sista funktioner) 
...
def continents_pie(data, measure): # visualisering av antal fall och dödsfall kontinentvis, measure = cases or deaths
...
def data_per_population_table(data, namnare): # visualisering av antal dödsfall och fall i relation med population samt relation mellan fall och dödsfall. 
...
def finnish_bar(data, title): # visualisering av antal fall stadvis samt åldergruppsvis i Finland
...
def finnish_municipalities_procentual_bar(case_data, population_data): # procentuella antalet fall per totala antalet invånare i finska kommuner
